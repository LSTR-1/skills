...
> **Platform Note:** State files use the platform's native directory: `.orchestrator/` (Claude Code),
> `.orchestrator/` (Codex CLI), or `.orchestrator/` (Cursor IDE). Shared metrics live in
...
> exists. Affected modules in this skill: `scripts/lib/convergence-monitor.mjs`.
...
- `.trae/rules/autonomous-agent-safety.md` (AAG-004) — branch-scoped experimentation contract
