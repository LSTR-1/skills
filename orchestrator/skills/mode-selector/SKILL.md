...
> exists. Affected modules in this skill: `scripts/lib/backlog-scan.mjs`, `scripts/lib/mode-selector-accuracy.mjs`, `scripts/lib/mode-selector.mjs`, `scripts/lib/recommendations-v0.mjs`, `scripts/lib/state-md.mjs`.
...
- Epic: [#271 v3.2 Autopilot](https://github.com/Kanevry/orchestrator/issues/271)
- Issue: [#276 Phase B Mode-Selector](https://github.com/Kanevry/orchestrator/issues/276)
