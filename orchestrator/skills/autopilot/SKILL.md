...
> exists. Affected modules in this skill: `scripts/lib/autopilot.mjs`, `scripts/lib/autopilot/worktree-pipeline.mjs`, `scripts/lib/build-live-signals.mjs`, `scripts/lib/mode-selector.mjs`, `scripts/lib/resource-probe.mjs`, `scripts/lib/session-registry.mjs`, `scripts/lib/state-md.mjs`.
...
- Epic: [#271 v3.2 Autopilot — Autonomous Session Orchestration](https://github.com/Kanevry/orchestrator/issues/271)
- Issues: [#277 Phase C scaffold](https://github.com/Kanevry/orchestrator/issues/277), [#295 Phase C-1 runtime](https://github.com/Kanevry/orchestrator/issues/295), [#300 Phase C-1.b follow-up](https://github.com/Kanevry/orchestrator/issues/300)
