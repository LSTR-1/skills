...
```
Task({ subagent_type: "search", description: "Analyze codebase for related patterns",
  query: "Use Glob and Grep to find existing implementations related to [feature topic].
...
Task({ subagent_type: "search", description: "Check VCS for related issues",
  query: "Use Bash to run VCS CLI (glab/gh, auto-detect per gitlab-ops skill).
...
Task({ subagent_type: "search", description: "Research best practices",
  query: "Use WebSearch to find best practices for [feature type].
...
```
Task({ subagent_type: "search", description: "Deep-read affected source files",
  query: "Read the specific files identified in Wave 1 findings.
  Trace call paths from entry points to data layer.
  Report: file list, function signatures, data flow, coupling points." })

Task({ subagent_type: "search", description: "Check test patterns for affected area",
  query: "Use Glob to find test files for the affected modules.
  Read test structure and coverage patterns.
  Report: existing test approach, gaps, suggested test strategy." })

Task({ subagent_type: "search", description: "Research technical approach",
  query: "Use WebSearch and WebFetch for the specific technical challenge identified.
