...
> exists. Affected modules in this skill: `scripts/lib/sunset/walker.mjs`.
...
- `.trae/rules/cli-design.md` — JSON-first / exit-code contract the walker follows.
- `.trae/rules/ask-via-tool.md` — AUQ-004 (agents cannot call AskUserQuestion).
