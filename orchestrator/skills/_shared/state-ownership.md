...
> exists. Affected modules in this file: `scripts/lib/autopilot/worktree-pipeline.mjs`, `scripts/lib/historical-guard.mjs`, `scripts/lib/session-id.mjs`, `scripts/lib/state-md.mjs`.
...
- **Discovery grep-verification** — distributional claims in W1 outputs (e.g., "N of M callers", "100% adopt pattern X") MUST quote the executed grep + file scope + count. See [`../../.trae/rules/parallel-sessions.md`](../../.trae/rules/parallel-sessions.md) § PSA-006.
