...
> exists. Affected modules in this file: `scripts/lib/autopilot/worktree-pipeline.mjs`.
...
- `.trae/rules/ask-via-tool.md` — AUQ-001 through AUQ-005 (always use the tool, not prose)
- `.trae/rules/parallel-sessions.md` — PSA-001/PSA-002 (overlap-check discipline)
